...
<form action="" method="post" name="frmTest" onsubmit="if(CheckForm() == false) return false">
	<table align="center" border="0">
        ...
        <?php
			...
			if($dem !="")
			{
				while($bien=$hienthi->fetch_assoc())
				{
		...
		?>
                   ...
                   <td class="tensp_hienthi_sp">
                    ...
                    <td class="active_hienthi_sp"><a href="#" > <img src="img/sua.png" title="Sửa" /></a>
					<?php echo "<p onclick = '#' ><img src='img/xoa.png' title='Xóa' class='delete'></p>" ?>
                   </td>
